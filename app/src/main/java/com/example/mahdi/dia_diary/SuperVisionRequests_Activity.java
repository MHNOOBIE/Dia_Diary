...
public class SuperVisionRequests_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_super_vision_requests);
        ...
        db.collection("Requests").document(doctor_id).collection("Pending").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if (patient_id.size() > 0) {
                    ...
                    pending_tv.setText("Almost done ...");
                    for (String pat_id : patient_id) {
                        ...
                        db.collection("Users").document(pat_id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (patientArrayList.size() > 0) {
                                    pending_tv.setText("Pending Requests");
                                    mRecyclerView = findViewById(R.id.recyclerView);
                                    mRecyclerView.setHasFixedSize(true);
                                    mLayoutManager = new LinearLayoutManager(SuperVisionRequests_Activity.this);
                     ...
                     mAdapter.setOnItemClickListener(new PatientAdapter.OnitemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                ...
                                Intent intent = new Intent(SuperVisionRequests_Activity.this,PatientDetails_Activity.class);
                                ...
                                startActivity(intent);
                                       ...
                                       Toast.makeText(SuperVisionRequests_Activity.this,"Oops! Something went wrong. Check your internet connection.",Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    pending_tv.setText("No Pending Requests");
                    Toast.makeText(SuperVisionRequests_Activity.this, "No pending requests.", Toast.LENGTH_LONG).show();
                }
            }
