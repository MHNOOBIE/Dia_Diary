...
public class SupervisedInsulin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supervised_insulin_);
        ...
        db.collection("InsulinEntry").document(pat_id).collection("Insulin").orderBy("time").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                for (DocumentSnapshot dc : queryDocumentSnapshots) {
                    ...
                    tableRow = new TableRow(SupervisedInsulin_Activity.this);

                    time_tv = new TextView(SupervisedInsulin_Activity.this);
                    insulin_tv = new TextView(SupervisedInsulin_Activity.this);
                ...
                if (lineEntry.size() > 0) {
                    ...
                    xAxis.setValueFormatter(new SupervisedInsulin_Activity.MyXAxisValueFormatter(null));
