...
public class Input_Acitivty extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input__acitivty);
        submit_bt = findViewById(R.id.submit_bt);
        glucose_et = findViewById(R.id.glucose_et);
    ...
    public void onClick(View v) {
            if(v.getId() == submit_bt.getId()){
                ...
                Date date = new Date(y,m,d,hour,min);
                ...
                db.collection("GlucoseEntry").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).collection("Glucose").add(glucose).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(Input_Acitivty.this,"Log Succesfully recorded.",Toast.LENGTH_LONG).show();

                        Intent intent = new Intent(Input_Acitivty.this,HomeActivity.class);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Input_Acitivty.this,"Failed to access database. Try again."+e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
            ...
            if(v.getId() == time_bt.getId()){
                ...
                timePickerDialog = new TimePickerDialog(Input_Acitivty.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            if(v.getId() == date_bt.getId()){
                ...
                datePickerDialog = new DatePickerDialog(Input_Acitivty.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
